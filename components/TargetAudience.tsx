...
export default function TargetAudience() {
  const cards = [
    {
      title: "Мамам у декреті (Шукачкам свободи)",
      text: "Ви любите свою сім'ю, але втомилися просити гроші у чоловіка чи рахувати декретні. Ви шукаєте роботу, яку можна робити вдома за 2-3 години, поки дитина спить, щоб здобути фінансову незалежність.",
      icon: <Unlock className="w-6 h-6 text-accent-primary" />,
    },
    {
      title: "Втомленим від «роботи на ногах» та системи",
      text: "Ви працюєте в б'юті-сфері, держслужбі або на важкій роботі за кордоном. Ви відчуваєте вигорання і хочете працювати головою, а не руками. Ваша мета — заробляти онлайн і не залежати від локації чи роботодавця.",
      icon: <CameraOff className="w-6 h-6 text-accent-primary" />,
    },
    {
      title: "«Інкогніто-креаторам» (Хто не хоче знімати себе)",
      text: "Ви хочете заробляти в соцмережах (Instagram, YouTube, TikTok), але вас дратує необхідність «танцювати в сторіз» або показувати своє життя. Ви хочете створювати красиві, глибокі відео без власного обличчя в кадрі (faceless контент).",
      icon: <Code2 className="w-6 h-6 text-accent-primary" />,
    },
    {
      title: "Творчим людям, які втомилися від «каші» в голові",
      text: "Ви вже дивилися безкоштовні уроки, але ШІ видає вам «мультики», обличчя персонажів постійно змінюються, а результату нуль. Вам потрібен покроковий алгоритм без складної технічної мови.",
