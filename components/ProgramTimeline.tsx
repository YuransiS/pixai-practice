...
export default function ProgramTimeline() {
  ...
  const steps = [
    {
      title: "ДЕНЬ 1: Ваше перше AI-відео в прямому ефірі",
      text: (
        <ul className="list-disc pl-5 space-y-3">
          <li><strong>Знімаємо страх перед технікою:</strong> чому ШІ — це як мікрохвильовка, якою легко користуватися</li>
          <li><strong>База та інтерфейс:</strong> куди натискати, щоб отримати результат (розбираємо формулу ідеального промпта)</li>
          <li><strong>Практика:</strong> Прямо під час ефіру ми разом оживимо історичне фото. Ви отримаєте своє перше готове відео</li>
        </ul>
      ),
    },
    {
      title: "ДЕНЬ 2: Комерція та як на цьому заробляти",
      text: (
        <ul className="list-disc pl-5 space-y-3">
          <li><strong>За що саме бізнес готовий платити вам від $500</strong></li>
          <li><strong>Практика:</strong> Зберемо рекламний ролик для бренду (предметна зйомка без камер та студій)</li>
          <li><strong>Покроковий план:</strong> як новачкові знайти перших клієнтів і вийти на стабільний онлайн-дохід</li>
        </ul>
      ),
    },
  ];
              ...
              >
                ...
                <div className={`w-full pl-12 md:pl-0 md:w-1/2 ${isEven ? 'md:pr-12 lg:pr-16 text-left md:text-right' : 'md:pl-12 lg:pl-16 text-left'}`}>
                  ...
                  >
                    ...
                    <div className="relative z-10 text-text-muted text-base">
                      {step.text}
                    </div>
                  </div>
                </div>
